# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Sat Aug 14 17:42:39 2021
#
...
class CVEFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Transform", "")
        self.Bind(wx.EVT_MENU, self.transform, id=item.GetId())
    ...
    def transform(self, event):  # wxGlade: CVEFrame.<event_handler>
        print("Event handler 'transform' not implemented!")
        event.Skip()
