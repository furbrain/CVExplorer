# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Sun Sep  5 13:39:34 2021
#
...
class CodeDialog(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        sizer_6.Add(self.text_ctrl_1, 1, wx.ALL | wx.EXPAND, 3)
...
class FunctionPaneBase(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.results_text = wx.TextCtrl(self.display_pane, wx.ID_ANY, "")
    ...
    def __do_layout(self):
        ...
        sizer_8.Add(self.results_bitmap, 0, wx.ALL, 3)
        sizer_8.Add(self.results_text, 0, wx.ALL, 3)
